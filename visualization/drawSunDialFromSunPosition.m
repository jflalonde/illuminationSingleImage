...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function figHandle = drawSunDialFromSunPosition(img, sunPosition, horizonLine, focalLength, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
defaultArgs = struct('CameraHeight', 1.6, 'StickPosition', [size(img,2)/2 0.9.*size(img,1)], 'StickHeight', 1.5, ...
    'GtZenith', -1, 'GtAzimuth', 0, 'DrawFlipped', 0);
...
plot(objectPx(1,:), objectPx(2,:), 'LineWidth', objectWidth, 'Color', objectColor, 'Marker', '.', 'MarkerSize', objectWidth*3);
...
plot(shadowPx(1,:), shadowPx(2,:), 'LineWidth', objectWidth, 'Color', shadowColor, ...
