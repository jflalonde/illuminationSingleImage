...
boundariesCatInterpVal = interp2(1:size(interpMap,2), 1:size(interpMap,1), interpMap, min(boundariesCat(:,1), size(interpMap,2)), min(boundariesCat(:,2), size(interpMap,1)));
